...
def content_for(p):
    s=p['slug']
    if s in ('akreditasyon-süreci','about-3-2','about-3-4'):return document_table(p)
...
def inner(p):
    ...
    if p['slug'] in ('akreditasyon-süreci','about-3-2','about-3-4'):page_class='wrap inner-page documents-page'
